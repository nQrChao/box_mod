...
import com.chaoji.mod.databinding.ModActivityMain5Binding
...
class ModActivityMain5 : BaseVmDbActivity<ModActivityMainModel5, ModActivityMain5Binding>() {
    ...
    override fun layoutId(): Int = R.layout.mod_activity_main5
    ...
    companion object {
        ...
        fun start(context: Context) {
            val intent = Intent(context, ModActivityMain5::class.java)
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mDataBinding.vpContent.apply {
            ...
            adapter = object : FragmentStateAdapter(this@ModActivityMain5) {
        ...
        mDataBinding.bbl.setOnItemSelectedListener { bottomBarItem, previousPosition, currentPosition ->
            ...
            KeyboardUtils.hideSoftInput(this@ModActivityMain5)
...
//    }
    override fun createObserver() {
        ...
        eventViewModelInstance.onKickedOffline.observe(this) {
            ...
            XPopup.Builder(this@ModActivityMain5)
                .dismissOnBackPressed(false)
                .dismissOnTouchOutside(false)
                .isDestroyOnDismiss(true)
                .hasStatusBar(true)
    ...
    private fun showLogView(show: Boolean) {
        if (show) {
            logToast = XToast<XToast<*>>(this).apply {
                contentView = LogcatDialog(this@ModActivityMain5)
    ...
    private fun showInfoView(show: Boolean) {
        if (show) {
            testToast = XToast<XToast<*>>(this).apply {
                contentView = InfoView.getView(this@ModActivityMain5)
