...
class Mod2Fragment1Model : BaseViewModel(leftTitle = "首页资讯") {
    var getChatId = ""
    ...
    var postDataAppApi85Result = MutableLiveData<ResultState<AppletsData>>()

    fun postDataAppApi85() {
        request({
            val map = mutableMapOf<String, String>()
            map["api"] = "market_data_appapi"
            map["market_data_id"] = "85"
            apiService.postDataAppApi(NetworkApi.INSTANCE.createPostData(map)!!)
        }, postDataAppApi85Result)
    }
