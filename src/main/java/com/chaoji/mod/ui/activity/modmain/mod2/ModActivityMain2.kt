...
import com.chaoji.im.sdk.ImSDK.Companion.isCreateMainActivity
import com.chaoji.im.sdk.ImSDK.Companion.mainActivityRef
import com.chaoji.im.sdk.appViewModel
import com.chaoji.im.sdk.eventViewModel
import com.chaoji.im.ui.widget.bottombar.BottomBarItem
import com.chaoji.im.utils.MMKVUtil
import com.chaoji.im.toBrowser
import com.chaoji.im.ui.view.InfoView
import com.chaoji.im.ui.widget.bottombar.BottomBarLayout
import com.chaoji.im.utils.floattoast.XToast
import com.chaoji.im.utils.floattoast.draggable.SpringHideTimeDraggable
import com.chaoji.im.utils.logcat.LogcatDialog
import com.chaoji.mod.R
import com.chaoji.mod.databinding.ModActivityMain2Binding
...
class ModActivityMain2 : BaseVmDbActivity<ModActivityMainModel2, ModActivityMain2Binding>() {
    ...
    override fun layoutId(): Int = R.layout.mod_activity_main2
    ...
    val fragments = arrayListOf(
        Mod2Fragment1.newInstance(),
        Mod2Fragment2.newInstance(),
        Mod2Fragment3.newInstance(),
        Mod2Fragment4.newInstance(),
    )
    ...
    companion object {
        ...
        fun start(context: Context) {
            val intent = Intent(context, ModActivityMain2::class.java)
...
//        }
        ...
        val tabTitles = resources.getStringArray(R.array.navigation_btn_name2)
        ...
        addBottomBarItems(listOf(0, 1, 2, 3)) // 传递需要显示的 item 的索引列表
        ...
        mDataBinding.vpContent.apply {
            ...
            adapter = object : FragmentStateAdapter(this@ModActivityMain2) {
        ...
        mDataBinding.bbl.setOnItemSelectedListener { bottomBarItem, previousPosition, currentPosition ->
            if (currentPosition == 3) {
                if (previousPosition == currentPosition) {
                    ...
                    mHandler.postDelayed(Runnable {
                        ...
                        bottomBarItem.setSelectedIcon(R.mipmap.mod_navigation_bg1) //更换成首页原来选中图标
            ...
            bottomItem.setSelectedIcon(R.mipmap.mod_navigation_bg4) //更换为原来的图标
            cancelTabLoading(bottomItem)
            KeyboardUtils.hideSoftInput(this@ModActivityMain2)
...
//    }
    override fun createObserver() {
        ...
        eventViewModelInstance.onKickedOffline.observe(this) {
            ...
            XPopup.Builder(this@ModActivityMain2)
                .dismissOnBackPressed(false)
                .dismissOnTouchOutside(false)
                .isDestroyOnDismiss(true)
                .hasStatusBar(true)
    ...
    private fun showLogView(show: Boolean) {
        if (show) {
            logToast = XToast<XToast<*>>(this).apply {
                contentView = LogcatDialog(this@ModActivityMain2)
    ...
    private fun showInfoView(show: Boolean) {
        if (show) {
            testToast = XToast<XToast<*>>(this).apply {
                contentView = InfoView.getView(this@ModActivityMain2)
