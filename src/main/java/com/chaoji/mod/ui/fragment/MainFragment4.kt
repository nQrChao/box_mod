...
import com.chaoji.mod.ui.activity.about.ModActivityAbout
import com.chaoji.im.ui.activity.CommonActivityBrowser
import com.chaoji.mod.ui.activity.ModActivityFanKui
import com.chaoji.im.ui.view.SwitchButton
import com.chaoji.im.ui.widget.XCollapsingToolbarLayout
import com.chaoji.im.utils.MMKVUtil
import com.chaoji.mod.R
import com.chaoji.mod.databinding.MainFragment4Binding
import com.chaoji.mod.ui.activity.jiaoyi.ModActivityJiaoYiList
import com.chaoji.mod.ui.activity.ModActivityMessage
import com.chaoji.mod.ui.activity.login.ModActivitySafety
import com.chaoji.mod.ui.activity.jiaoyi.ModActivityShouCang
...
import com.chaoji.other.kongzue.baseokhttp.listener.ResponseListener
        ...
        fun quit() {
            XPopup.Builder(context)
                ...
                .asConfirm(
                    ...
                    }, null, false, com.chaoji.common.R.layout.xpopup_confirm
                ).show()
        }
