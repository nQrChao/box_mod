...
import com.chaoji.mod.ui.activity.jiaoyi.ModActivityTradeListMore
import com.chaoji.mod.ui.activity.jiaoyi.ModXPopupJiaoyiShangJiaGroup
...
class FragmentNavigation1 : BaseTitleBarFragment<Navigation1Model, FragmentNavigation1Binding>(), Nav1ClickHandler, StatusAction {
    ...
    override fun layoutId(): Int = R.layout.fragment_navigation1

    companion object {
        fun newInstance(): FragmentNavigation1 = FragmentNavigation1()
    }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mDataBinding.unifiedRecyclerView.apply {
            val layoutManager = GridLayoutManager(context, 2)
            layoutManager.spanSizeLookup = object : GridLayoutManager.SpanSizeLookup() {
                override fun getSpanSize(position: Int): Int {
                    return when (unifiedAdapter.currentList.getOrNull(position)) {
                        is Navigation11ListItem.GoodsItem -> 1
                        else -> 2
                    }
                }
            }
        ...
        mViewModel.topGameInfo.observe(this) { resultState ->
            parseModStateWithMsg(resultState,
                onSuccess = { data, msg ->
                    ...
                    //topGoodsItem = mViewModel.topGoodsList.value?.take(20)?.let {
                    //    Navigation11ListItem.TopGoodsItem(it)
                    //}
                    topTitleItem2 = Navigation11ListItem.Title2Item("成品账号", false, true)
                    refreshList()
    ...
    override fun onSearchClick() {
        ModActivityTradeListMore.start(appContext)
    }
    ...
    override fun onMainGoodsItemChildClick(goodDetail: ModTradeGoodDetailBean, view: View) {
        lifecycleScope.launch {
            ...
            if (imageIndex != -1) {
                ...
                ModActivityTradeDetails.start(mActivity, goodDetail.gid)
            } else if (view.id == R.id.goumai_layout) {
                Toaster.show("去购买")
            }
        }
    }
