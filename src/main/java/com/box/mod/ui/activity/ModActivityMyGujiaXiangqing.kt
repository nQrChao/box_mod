...
import com.box.mod.databinding.ModActivityMyGujiaXiangqingBinding
...
class ModActivityMyGujiaXiangqing :
    BaseVmDbActivity<ModActivityMyGujiaXiangqing.Model, ModActivityMyGujiaXiangqingBinding>() {
    ...
    override fun layoutId(): Int = R.layout.mod_activity_my_gujia_xiangqing

    companion object {
        const val INTENT_KEY_TYPE_GUJIA_ID: String = "gujiaId"
        fun start(context: Context, id: String) {
            val intent = Intent(context, ModActivityMyGujiaXiangqing::class.java)
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mDataBinding.recyclerView.run {
            ...
            adapter = fromsAdapter
        }
        fromsAdapter.setOnItemClickListener { adapter, view, position ->
            val bean = adapter.data[position] as ModValuationCommitBean
        }

        picAdapter.setDiffCallback(ModXiangqingPicDiffCallback())
        ...
        picAdapter.setOnItemClickListener { adapter, view, position ->
            val createTypeBean = adapter.data[position] as String
        }
