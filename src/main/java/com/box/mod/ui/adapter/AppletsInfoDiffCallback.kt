...
class AppletsInfoDiffCallback : DiffUtil.ItemCallback<ModInfo>() {

    /**
     * 判断是否是同一个 item
     * @return true 如果是同一个 item, false 则不是
     */
    override fun areItemsTheSame(oldItem: ModInfo, newItem: ModInfo): Boolean {
     ...
     */
    override fun areContentsTheSame(oldItem: ModInfo, newItem: ModInfo): Boolean {
