...
class AppletsInfoDiffCallback : DiffUtil.ItemCallback<AppletsInfo>() {

    /**
     * 判断是否是同一个 item
     * @return true 如果是同一个 item, false 则不是
     */
    override fun areItemsTheSame(oldItem: AppletsInfo, newItem: AppletsInfo): Boolean {
     ...
     */
    override fun areContentsTheSame(oldItem: AppletsInfo, newItem: AppletsInfo): Boolean {
